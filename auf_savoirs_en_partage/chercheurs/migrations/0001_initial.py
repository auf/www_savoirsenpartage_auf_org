...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chercheurs_personne', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('salutation', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ...
            ('fonction', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('date_naissance', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sousfonction', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ...
        db.send_create_signal('chercheurs', ['Personne'])

        # Adding model 'Chercheur'
        db.create_table('chercheurs_chercheur', (
            ('personne_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chercheurs.Personne'], unique=True, primary_key=True)),
            ('nationalite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='nationalite', null=True, db_column='nationalite', to=orm['datamaster_modeles.Pays'])),
            ('statut', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('diplome', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('etablissement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Etablissement'], null=True, db_column='etablissement', blank=True)),
            ('etablissement_autre_nom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('etablissement_autre_pays', self.gf('django.db.models.fields.related.ForeignKey')(related_name='etablissement_autre_pays', blank=True, null=True, db_column='etablissement_autre_pays', to=orm['datamaster_modeles.Pays'])),
            ('attestation', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('thematique', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Thematique'], null=True, db_column='thematique')),
            ('mots_cles', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('discipline', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['savoirs.Discipline'], null=True, db_column='discipline')),
            ('theme_recherche', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('groupe_recherche', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('url_site_web', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('url_blog', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('url_reseau_social', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('membre_instance_auf', self.gf('django.db.models.fields.NullBooleanField')(null=True)),
            ('membre_instance_auf_nom', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('membre_instance_auf_fonction', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('membre_instance_auf_dates', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('expert_oif', self.gf('django.db.models.fields.NullBooleanField')(null=True)),
            ('expert_oif_details', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('expert_oif_dates', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('membre_association_francophone', self.gf('django.db.models.fields.NullBooleanField')(null=True)),
            ('membre_association_francophone_details', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('membre_reseau_institutionnel', self.gf('django.db.models.fields.NullBooleanField')(null=True)),
            ('membre_reseau_institutionnel_nom', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
            ('membre_reseau_institutionnel_fonction', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('membre_reseau_institutionnel_dates', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('expertises_auf', self.gf('django.db.models.fields.NullBooleanField')(null=True)),
            ('date_creation', self.gf('django.db.models.fields.DateField')(auto_now_add=True, db_column='date_creation', blank=True)),
            ('date_modification', self.gf('django.db.models.fields.DateField')(auto_now=True, db_column='date_modification', blank=True)),
        ))
        db.send_create_signal('chercheurs', ['Chercheur'])

        # Adding model 'Publication'
        db.create_table('chercheurs_publication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('chercheur', self.gf('django.db.models.fields.related.ForeignKey')(related_name='publications', to=orm['chercheurs.Chercheur'])),
            ...
            ('lieu_edition', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('publication_affichage', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('actif', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('chercheurs', ['Publication'])

        # Adding model 'These'
        db.create_table('chercheurs_these', (
            ('chercheur', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chercheurs.Chercheur'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('chercheurs', ['These'])

        # Adding model 'Expertise'
        db.create_table('chercheurs_expertise', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column='id')),
            ('chercheur', self.gf('django.db.models.fields.related.ForeignKey')(related_name='expertises', to=orm['chercheurs.Chercheur'])),
            ...
            ('lieu', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('organisme_demandeur', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('organisme_demandeur_visible', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('actif', self.gf('django.db.models.fields.BooleanField')(default=False, db_column='actif')),
        ))
        db.send_create_signal('chercheurs', ['Expertise'])

        # Adding model 'Groupe'
        db.create_table('chercheurs_groupe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column='id')),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=255, db_column='nom')),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('liste_diffusion', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('bulletin', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('actif', self.gf('django.db.models.fields.BooleanField')(default=False, db_column='actif')),
        ))
        db.send_create_signal('chercheurs', ['Groupe'])

        # Adding model 'ChercheurGroupe'
        db.create_table('chercheurs_chercheurgroupe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column='id')),
            ('chercheur', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chercheurs.Chercheur'], db_column='chercheur')),
            ('groupe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chercheurs.Groupe'], db_column='groupe')),
            ('date_inscription', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('date_modification', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('actif', self.gf('django.db.models.fields.BooleanField')(default=False, db_column='actif')),
        ))
        db.send_create_signal('chercheurs', ['ChercheurGroupe'])


    def backwards(self, orm):
        
        # Deleting model 'Personne'
        db.delete_table('chercheurs_personne')

        # Deleting model 'Chercheur'
        db.delete_table('chercheurs_chercheur')

        # Deleting model 'Publication'
        db.delete_table('chercheurs_publication')

        # Deleting model 'These'
        db.delete_table('chercheurs_these')

        # Deleting model 'Expertise'
        db.delete_table('chercheurs_expertise')

        # Deleting model 'Groupe'
        db.delete_table('chercheurs_groupe')

        # Deleting model 'ChercheurGroupe'
        db.delete_table('chercheurs_chercheurgroupe')
    ...
    models = {
        'chercheurs.chercheur': {
            ...
            'groupes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['chercheurs.Groupe']", 'through': "'ChercheurGroupe'", 'blank': 'True'}),
