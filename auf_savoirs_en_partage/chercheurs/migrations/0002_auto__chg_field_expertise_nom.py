...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Expertise.nom'
        db.alter_column('chercheurs_expertise', 'nom', self.gf('django.db.models.fields.CharField')(default='', max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Expertise.nom'
        db.alter_column('chercheurs_expertise', 'nom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
