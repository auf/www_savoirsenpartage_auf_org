...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Personne.afficher_courriel'
        db.add_column('chercheurs_personne', 'afficher_courriel', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Personne.afficher_courriel'
        db.delete_column('chercheurs_personne', 'afficher_courriel')
