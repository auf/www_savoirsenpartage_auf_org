...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChercheurSearch.groupe_chercheur'
        db.add_column('chercheurs_chercheursearch', 'groupe_chercheur', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chercheurs.Groupe'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChercheurSearch.groupe_chercheur'
        db.delete_column('chercheurs_chercheursearch', 'groupe_chercheur_id')
