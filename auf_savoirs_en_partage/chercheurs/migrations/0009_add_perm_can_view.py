...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(model='chercheur', app_label='chercheurs')
        perm, created = orm['auth.permission'].objects.get_or_create(content_type=ct, codename='view_chercheur')
        if created:
            perm.name=u'Peut visualiser la liste des chercheurs'
            perm.save()
