...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupeSearch'
        db.create_table('chercheurs_groupesearch', (
            ('search_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['savoirs.Search'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('chercheurs', ['GroupeSearch'])


    def backwards(self, orm):
        
        # Deleting model 'GroupeSearch'
        db.delete_table('chercheurs_groupesearch')
