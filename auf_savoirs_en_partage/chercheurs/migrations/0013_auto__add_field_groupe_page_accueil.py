...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Groupe.page_accueil'
        db.add_column('chercheurs_groupe', 'page_accueil', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Groupe.page_accueil'
        db.delete_column('chercheurs_groupe', 'page_accueil')
