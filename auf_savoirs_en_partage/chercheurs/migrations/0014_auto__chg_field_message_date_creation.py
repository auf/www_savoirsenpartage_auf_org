...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.date_creation'
        db.alter_column('chercheurs_message', 'date_creation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_column='date_creation'))


    def backwards(self, orm):
        
        # Changing field 'Message.date_creation'
        db.alter_column('chercheurs_message', 'date_creation', self.gf('django.db.models.fields.DateField')(auto_now_add=True, db_column='date_creation'))
