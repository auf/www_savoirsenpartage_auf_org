...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field recherches on 'Groupe'
        db.create_table('chercheurs_groupe_recherches', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('groupe', models.ForeignKey(orm['chercheurs.groupe'], null=False)),
            ('search', models.ForeignKey(orm['savoirs.search'], null=False))
        ))
        db.create_unique('chercheurs_groupe_recherches', ['groupe_id', 'search_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field recherches on 'Groupe'
        db.delete_table('chercheurs_groupe_recherches')
