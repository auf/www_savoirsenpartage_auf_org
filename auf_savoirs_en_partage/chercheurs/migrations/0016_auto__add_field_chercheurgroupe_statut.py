...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChercheurGroupe.statut'
        db.add_column('chercheurs_chercheurgroupe', 'statut', self.gf('django.db.models.fields.CharField')(default='nouveau', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChercheurGroupe.statut'
        db.delete_column('chercheurs_chercheurgroupe', 'statut')
    ...
    models = {
        ...
        'chercheurs.chercheur': {
            ...
            'groupes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'membres'", 'blank': 'True', 'through': "orm['chercheurs.ChercheurGroupe']", 'to': "orm['chercheurs.Groupe']"}),
        ...
        'chercheurs.chercheurgroupe': {
            'Meta': {'ordering': "['chercheur']", 'object_name': 'ChercheurGroupe'},
