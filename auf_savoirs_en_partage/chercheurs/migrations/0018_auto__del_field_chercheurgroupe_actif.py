...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ChercheurGroupe.actif'
        db.delete_column('chercheurs_chercheurgroupe', 'actif')


    def backwards(self, orm):
        
        # Adding field 'ChercheurGroupe.actif'
        db.add_column('chercheurs_chercheurgroupe', 'actif', self.gf('django.db.models.fields.BooleanField')(default=False, db_column='actif'), keep_default=False)
