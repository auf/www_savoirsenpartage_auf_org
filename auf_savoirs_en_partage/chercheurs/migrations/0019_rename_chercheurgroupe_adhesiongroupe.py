...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming model 'ChercheurGroupe' to 'AdhesionGroupe'
        db.rename_table('chercheurs_chercheurgroupe', 'chercheurs_adhesiongroupe')


    def backwards(self, orm):
        
        # Renaming model 'AdhesionGroupe' to 'ChercheurGroupe'
        db.rename_table('chercheurs_adhesiongroupe', 'chercheurs_chercheurgroupe')
