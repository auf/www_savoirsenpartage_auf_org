...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChercheurSearch.equipe_recherche'
        db.add_column('chercheurs_chercheursearch', 'equipe_recherche', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Chercheur.equipe_recherche'
        db.add_column('chercheurs_chercheur', 'equipe_recherche', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChercheurSearch.equipe_recherche'
        db.delete_column('chercheurs_chercheursearch', 'equipe_recherche')

        # Deleting field 'Chercheur.equipe_recherche'
        db.delete_column('chercheurs_chercheur', 'equipe_recherche')
