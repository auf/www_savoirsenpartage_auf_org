...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for chercheur in orm.Chercheur.objects.all():
            chercheur.equipe_recherche = chercheur.groupe_recherche
            chercheur.save()

        for chercheursearch in orm.ChercheurSearch.objects.all():
            chercheursearch.equipe_recherche = chercheursearch.groupe_recherche
            chercheursearch.save()


    def backwards(self, orm):
        for chercheur in orm.Chercheur.objects.all():
            chercheur.groupe_recherche = chercheur.equipe_recherche
            chercheur.save()

        for chercheursearch in orm.ChercheurSearch.objects.all():
            chercheursearch.groupe_recherche = chercheursearch.equipe_recherche
            chercheursearch.save()
