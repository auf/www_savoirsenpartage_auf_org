...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ChercheurSearch.groupe_recherche'
        db.delete_column('chercheurs_chercheursearch', 'groupe_recherche')

        # Deleting field 'Chercheur.groupe_recherche'
        db.delete_column('chercheurs_chercheur', 'groupe_recherche')


    def backwards(self, orm):
        
        # Adding field 'ChercheurSearch.groupe_recherche'
        db.add_column('chercheurs_chercheursearch', 'groupe_recherche', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Chercheur.groupe_recherche'
        db.add_column('chercheurs_chercheur', 'groupe_recherche', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
