...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'ChercheurSearch.pays'
        db.alter_column('chercheurs_chercheursearch', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Pays'], null=True))

        # Changing field 'Chercheur.thematique'
        db.alter_column('chercheurs_chercheur', 'thematique', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Thematique'], null=True, db_column='thematique'))

        # Changing field 'Chercheur.nationalite'
        db.alter_column('chercheurs_chercheur', 'nationalite', self.gf('django.db.models.fields.related.ForeignKey')(to_field='code', null=True, db_column='nationalite', to=orm['references.Pays']))

        # Changing field 'Chercheur.etablissement_autre_pays'
        db.alter_column('chercheurs_chercheur', 'etablissement_autre_pays', self.gf('django.db.models.fields.related.ForeignKey')(db_column='etablissement_autre_pays', to_field='code', to=orm['references.Pays'], null=True))

        # Changing field 'Chercheur.etablissement'
        db.alter_column('chercheurs_chercheur', 'etablissement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Etablissement'], null=True, db_column='etablissement'))

    def backwards(self, orm):
        # Changing field 'ChercheurSearch.pays'
        db.alter_column('chercheurs_chercheursearch', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Pays'], null=True))

        # Changing field 'Chercheur.thematique'
        db.alter_column('chercheurs_chercheur', 'thematique', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Thematique'], null=True, db_column='thematique'))

        # Changing field 'Chercheur.nationalite'
        db.alter_column('chercheurs_chercheur', 'nationalite', self.gf('django.db.models.fields.related.ForeignKey')(null=True, db_column='nationalite', to=orm['datamaster_modeles.Pays']))

        # Changing field 'Chercheur.etablissement_autre_pays'
        db.alter_column('chercheurs_chercheur', 'etablissement_autre_pays', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['datamaster_modeles.Pays'], db_column='etablissement_autre_pays'))

        # Changing field 'Chercheur.etablissement'
        db.alter_column('chercheurs_chercheur', 'etablissement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Etablissement'], null=True, db_column='etablissement'))
