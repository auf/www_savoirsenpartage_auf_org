...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChercheurSearch.expertises_auf'
        db.add_column('chercheurs_chercheursearch', 'expertises_auf',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ChercheurSearch.habilite_recherches'
        db.add_column('chercheurs_chercheursearch', 'habilite_recherches',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChercheurSearch.expertises_auf'
        db.delete_column('chercheurs_chercheursearch', 'expertises_auf')

        # Deleting field 'ChercheurSearch.habilite_recherches'
        db.delete_column('chercheurs_chercheursearch', 'habilite_recherches')
