...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FaunAuteur'
        db.create_table('interfaces_faunauteur', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('faun_auteur', self.gf('django.db.models.fields.IntegerField')()),
            ('sep_chercheur', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chercheurs.Chercheur'])),
        ))
        db.send_create_signal('interfaces', ['FaunAuteur'])


    def backwards(self, orm):
        
        # Deleting model 'FaunAuteur'
        db.delete_table('interfaces_faunauteur')
    ...
    models = {
        ...
        'interfaces.faunauteur': {
            'Meta': {'object_name': 'FaunAuteur'},
            'faun_auteur': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sep_chercheur': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chercheurs.Chercheur']"})
        },
        'savoirs.discipline': {
