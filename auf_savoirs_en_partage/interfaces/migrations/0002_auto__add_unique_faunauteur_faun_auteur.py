...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FaunAuteur', fields ['faun_auteur']
        db.create_unique('interfaces_faunauteur', ['faun_auteur'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FaunAuteur', fields ['faun_auteur']
        db.delete_unique('interfaces_faunauteur', ['faun_auteur'])
    ...
    models = {
        ...
        'interfaces.faunauteur': {
            ...
            'faun_auteur': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
