...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RappelModele'
        db.create_table('rappels_rappelmodele', (
        ...
        db.send_create_signal('rappels', ['RappelModele'])


    def backwards(self, orm):
        
        # Deleting model 'RappelModele'
        db.delete_table('rappels_rappelmodele')
