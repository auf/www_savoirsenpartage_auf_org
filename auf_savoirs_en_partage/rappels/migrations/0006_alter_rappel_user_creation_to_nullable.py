...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rappel.user_creation'
        db.alter_column('rappels_rappel', 'user_creation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Rappel.user_creation'
        db.alter_column('rappels_rappel', 'user_creation_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
