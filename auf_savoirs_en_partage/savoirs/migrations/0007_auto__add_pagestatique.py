...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('savoirs_pagestatique', (
        ...
        db.send_create_signal('savoirs', ['PageStatique'])


    def backwards(self, orm):
        
        # Deleting model 'PageStatique'
        db.delete_table('savoirs_pagestatique')
    ...
    models = {
        ...
        'savoirs.evenement': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'2459ba84-33d3-11e0-bf6e-f0def13a5ffb'", 'max_length': '255'}),
