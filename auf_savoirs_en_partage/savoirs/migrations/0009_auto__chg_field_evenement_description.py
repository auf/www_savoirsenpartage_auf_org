...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evenement.description'
        db.alter_column('savoirs_evenement', 'description', self.gf('django.db.models.fields.TextField')(default=''))


    def backwards(self, orm):
        
        # Changing field 'Evenement.description'
        db.alter_column('savoirs_evenement', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'savoirs.evenement': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a3d5ab36-394d-11e0-965a-f0def13a5ffb'", 'max_length': '255'}),
