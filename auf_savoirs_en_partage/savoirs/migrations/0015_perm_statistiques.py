...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(model='', app_label='savoirs', name='savoirs')
        ct.save()
        p, created = orm['auth.Permission'].objects.get_or_create(codename='statistiques', content_type=ct, name='statistiques')
        p.save()
