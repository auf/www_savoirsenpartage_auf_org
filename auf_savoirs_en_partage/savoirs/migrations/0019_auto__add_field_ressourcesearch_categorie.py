...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RessourceSearch.categorie'
        db.add_column('savoirs_ressourcesearch', 'categorie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['savoirs.RecordCategorie'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RessourceSearch.categorie'
        db.delete_column('savoirs_ressourcesearch', 'categorie_id')
    ...
    models = {
        ...
        'savoirs.evenement': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'0df53fdc-d4b6-11e0-a2b9-001bfca72efc'", 'max_length': '255'}),
