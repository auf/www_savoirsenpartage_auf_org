...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Search.q'
        db.alter_column('savoirs_search', 'q', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Search.q'
        db.alter_column('savoirs_search', 'q', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'savoirs.evenement': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'035de66e-fa86-11e0-8abe-001bfca72efc'", 'max_length': '255'}),
