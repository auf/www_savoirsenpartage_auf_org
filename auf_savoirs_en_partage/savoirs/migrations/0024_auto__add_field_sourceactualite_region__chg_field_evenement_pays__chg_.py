...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SourceActualite.region'
        db.add_column('savoirs_sourceactualite', 'region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Region'], null=True, blank=True), keep_default=False)

        # Changing field 'Evenement.pays'
        db.alter_column('savoirs_evenement', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to_field='code', null=True, to=orm['references.Pays']))

        # Changing field 'ActualiteSearch.search_ptr'
        db.alter_column('savoirs_actualitesearch', 'search_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['savoirs.Search'], unique=True, primary_key=True))


    def backwards(self, orm):
        
        # Deleting field 'SourceActualite.region'
        db.delete_column('savoirs_sourceactualite', 'region_id')

        # Changing field 'Evenement.pays'
        db.alter_column('savoirs_evenement', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['references.Pays']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 17, 1, 44, 4564)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 17, 1, 44, 4485)'}),
        ...
        'savoirs.evenement': {
            ...
            'pays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'evenements'", 'to_field': "'code'", 'null': 'True', 'to': "orm['references.Pays']"}),
            ...
            'type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'38fc275e-fde6-11e1-b02e-485d6096b84f'", 'max_length': '255'}),
