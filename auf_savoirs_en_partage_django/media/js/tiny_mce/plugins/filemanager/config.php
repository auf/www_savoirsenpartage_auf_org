<?php
	...
	$mcFileManagerConfig['general.disabled_tools'] = "createdoc,zip,cut,copy,paste,addfavorite,removefavorite";
	...
	$mcFileManagerConfig['filesystem.path'] = dirname(__FILE__).'/../../../../media/upload'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = dirname(__FILE__).'/../../../../media/upload'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,doc,xls,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,pdf,txt,zip,doc,xls";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,jpeg,png,pdf,txt,zip,doc,xls";
	...
	$mcFileManagerConfig['authenticator.login_page'] = "../../../../404.php";
	$mcFileManagerConfig['authenticator.allow_override'] = "*";

	// SessionAuthenticator
	$mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "tinymceLogin";
