<?php
	...
	$cfg['valid']  		= array('gif', 'jpg', 'jpeg');						// valid extentions for image files	
	...
	$cfg['ilibs_dir'] 	   = array('/media/upload/images/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
